...
public class TweakerMoreConfigs {
    ...
    @Config (type = Config.Type.TWEAK, restriction = @Restriction (require = @Condition (itemscroller)), category = Config.Category.FEATURES)
    public static final TweakerMoreConfigBooleanHotkeyed AUTO_FILL_CONTAINER_CLOSE = newConfigBooleanHotkeyed("autoFillContainerClose");
    ...
    @Config (type = Config.Type.LIST, restriction = @Restriction (require = @Condition (itemscroller)), category = Config.Category.FEATURES)
    public static final TweakerMoreConfigOptionList AUTO_FILL_CONTAINER_LIST_TYPE = newConfigOptionList("autoFillContainerListType", UsageRestriction.ListType.NONE);

    @Config (type = Config.Type.LIST, restriction = @Restriction (require = @Condition (itemscroller)), category = Config.Category.FEATURES)
    public static final TweakerMoreConfigStringList AUTO_FILL_CONTAINER_WHITELIST = newConfigStringList("autoFillContainerWhiteList", ImmutableList.of(RegistryUtil.getItemId(Items.ENCHANTED_BOOK)));

    @Config (type = Config.Type.LIST, restriction = @Restriction (require = @Condition (itemscroller)), category = Config.Category.FEATURES)
    public static final TweakerMoreConfigStringList AUTO_FILL_CONTAINER_BLACKLIST = newConfigStringList("autoFillContainerBlackList", ImmutableList.of(RegistryUtil.getItemId(Items.EMERALD)));

    public static final ItemRestriction AUTO_FILL_CONTAINER_RESTRICTION = new ItemRestriction();
    ...
    @Config (type = Config.Type.TWEAK, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigBooleanHotkeyed INFO_VIEW_VILLAGER = newConfigBooleanHotkeyed("infoViewVillager");

    @Config (type = Config.Type.TWEAK, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigBooleanHotkeyed INFO_VIEW_VILLAGER_UPDATE = newConfigBooleanHotkeyed("infoViewVillagerUpdate");
    ...
    @Config (type = Config.Type.LIST, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigStringList INFO_VIEW_VILLAGER_ENCHANTED_ITEMS_LIST = newConfigStringList("infoViewVillagerEnchantedItemsList", ImmutableList.of(
            RegistryUtil.getItemId(Items.DIAMOND_SWORD), RegistryUtil.getItemId(Items.DIAMOND_AXE), RegistryUtil.getItemId(Items.DIAMOND_PICKAXE),
            RegistryUtil.getItemId(Items.DIAMOND_SHOVEL), RegistryUtil.getItemId(Items.DIAMOND_HOE), RegistryUtil.getItemId(Items.DIAMOND_BOOTS),
            RegistryUtil.getItemId(Items.DIAMOND_LEGGINGS), RegistryUtil.getItemId(Items.DIAMOND_CHESTPLATE), RegistryUtil.getItemId(Items.DIAMOND_HELMET),

            RegistryUtil.getItemId(Items.FISHING_ROD), RegistryUtil.getItemId(Items.BOW), RegistryUtil.getItemId(Items.CROSSBOW)
    ));
    public static final ItemRestriction INFO_VIEW_VILLAGER_ENCHANTED_ITEMS_RESTRICTION = new ItemRestriction();

    @Config (type = Config.Type.GENERIC, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigBoolean INFO_VIEW_VILLAGER_ENCHANTED_ITEMS_MAX = newConfigBoolean("infoViewVillagerEnchantedItemsMax", true);

    @Config (type = Config.Type.GENERIC, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigBoolean INFO_VIEW_VILLAGER_ITEMS = newConfigBoolean("infoViewVillagerItems",true);

    @Config (type = Config.Type.LIST, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigStringList INFO_VIEW_VILLAGER_ITEMS_LIST = newConfigStringList("infoViewVillagerItemsList", ImmutableList.of(
            // Mason
            RegistryUtil.getItemId(Items.QUARTZ_BLOCK), RegistryUtil.getItemId(Items.QUARTZ_PILLAR), RegistryUtil.getItemId(Items.POLISHED_ANDESITE), RegistryUtil.getItemId(Items.POLISHED_DIORITE), RegistryUtil.getItemId(Items.POLISHED_GRANITE), RegistryUtil.getItemId(Items.TERRACOTTA),
            RegistryUtil.getItemId(Items.BLACK_TERRACOTTA), RegistryUtil.getItemId(Items.GRAY_TERRACOTTA), RegistryUtil.getItemId(Items.LIGHT_GRAY_TERRACOTTA), RegistryUtil.getItemId(Items.WHITE_TERRACOTTA), RegistryUtil.getItemId(Items.BROWN_TERRACOTTA),
            RegistryUtil.getItemId(Items.RED_TERRACOTTA), RegistryUtil.getItemId(Items.ORANGE_TERRACOTTA), RegistryUtil.getItemId(Items.YELLOW_TERRACOTTA), RegistryUtil.getItemId(Items.LIME_TERRACOTTA), RegistryUtil.getItemId(Items.GREEN_TERRACOTTA), RegistryUtil.getItemId(Items.CYAN_TERRACOTTA), RegistryUtil.getItemId(Items.LIGHT_BLUE_TERRACOTTA), RegistryUtil.getItemId(Items.BLUE_TERRACOTTA), RegistryUtil.getItemId(Items.MAGENTA_TERRACOTTA), RegistryUtil.getItemId(Items.PURPLE_TERRACOTTA), RegistryUtil.getItemId(Items.PINK_TERRACOTTA),
            // ToolSmith
            RegistryUtil.getItemId(Items.DIAMOND_HOE),
            // Weapon smith
            // Armorer
            RegistryUtil.getItemId(Items.SHIELD),
            // Librarian
            RegistryUtil.getItemId(Items.LANTERN), RegistryUtil.getItemId(Items.BOOKSHELF), RegistryUtil.getItemId(Items.GLASS), RegistryUtil.getItemId(Items.CLOCK), RegistryUtil.getItemId(Items.COMPASS),
            // Leather worker
            // Shepherd
            RegistryUtil.getItemId(Items.BLACK_WOOL), RegistryUtil.getItemId(Items.GRAY_WOOL), RegistryUtil.getItemId(Items.LIGHT_GRAY_WOOL), RegistryUtil.getItemId(Items.WHITE_WOOL), RegistryUtil.getItemId(Items.BROWN_WOOL),
            RegistryUtil.getItemId(Items.RED_WOOL), RegistryUtil.getItemId(Items.ORANGE_WOOL), RegistryUtil.getItemId(Items.YELLOW_WOOL), RegistryUtil.getItemId(Items.LIME_WOOL), RegistryUtil.getItemId(Items.GREEN_WOOL), RegistryUtil.getItemId(Items.CYAN_WOOL), RegistryUtil.getItemId(Items.LIGHT_BLUE_WOOL), RegistryUtil.getItemId(Items.BLUE_WOOL), RegistryUtil.getItemId(Items.MAGENTA_WOOL), RegistryUtil.getItemId(Items.PURPLE_WOOL), RegistryUtil.getItemId(Items.PINK_WOOL),

            RegistryUtil.getItemId(Items.BLACK_CARPET), RegistryUtil.getItemId(Items.GRAY_CARPET), RegistryUtil.getItemId(Items.LIGHT_GRAY_CARPET), RegistryUtil.getItemId(Items.WHITE_CARPET), RegistryUtil.getItemId(Items.BROWN_CARPET),
            RegistryUtil.getItemId(Items.RED_CARPET), RegistryUtil.getItemId(Items.ORANGE_CARPET), RegistryUtil.getItemId(Items.YELLOW_CARPET), RegistryUtil.getItemId(Items.LIME_CARPET), RegistryUtil.getItemId(Items.GREEN_CARPET), RegistryUtil.getItemId(Items.CYAN_CARPET), RegistryUtil.getItemId(Items.LIGHT_BLUE_CARPET), RegistryUtil.getItemId(Items.BLUE_CARPET), RegistryUtil.getItemId(Items.MAGENTA_CARPET), RegistryUtil.getItemId(Items.PURPLE_CARPET), RegistryUtil.getItemId(Items.PINK_CARPET),

            RegistryUtil.getItemId(Items.BLACK_BED), RegistryUtil.getItemId(Items.GRAY_BED), RegistryUtil.getItemId(Items.LIGHT_GRAY_BED), RegistryUtil.getItemId(Items.WHITE_BED), RegistryUtil.getItemId(Items.BROWN_BED),
            RegistryUtil.getItemId(Items.RED_BED), RegistryUtil.getItemId(Items.ORANGE_BED), RegistryUtil.getItemId(Items.YELLOW_BED), RegistryUtil.getItemId(Items.LIME_BED), RegistryUtil.getItemId(Items.GREEN_BED), RegistryUtil.getItemId(Items.CYAN_BED), RegistryUtil.getItemId(Items.LIGHT_BLUE_BED), RegistryUtil.getItemId(Items.BLUE_BED), RegistryUtil.getItemId(Items.MAGENTA_BED), RegistryUtil.getItemId(Items.PURPLE_BED), RegistryUtil.getItemId(Items.PINK_BED),

            RegistryUtil.getItemId(Items.BLACK_BANNER), RegistryUtil.getItemId(Items.GRAY_BANNER), RegistryUtil.getItemId(Items.LIGHT_GRAY_BANNER), RegistryUtil.getItemId(Items.WHITE_BANNER), RegistryUtil.getItemId(Items.BROWN_BANNER),
            RegistryUtil.getItemId(Items.RED_BANNER), RegistryUtil.getItemId(Items.ORANGE_BANNER), RegistryUtil.getItemId(Items.YELLOW_BANNER), RegistryUtil.getItemId(Items.LIME_BANNER), RegistryUtil.getItemId(Items.GREEN_BANNER), RegistryUtil.getItemId(Items.CYAN_BANNER), RegistryUtil.getItemId(Items.LIGHT_BLUE_BANNER), RegistryUtil.getItemId(Items.BLUE_BANNER), RegistryUtil.getItemId(Items.MAGENTA_BANNER), RegistryUtil.getItemId(Items.PURPLE_BANNER), RegistryUtil.getItemId(Items.PINK_BANNER),

            // Farmer
            RegistryUtil.getItemId(Items.APPLE), RegistryUtil.getItemId(Items.PUMPKIN_PIE), RegistryUtil.getItemId(Items.BREAD),
            // Cleric
            // Butcher
            RegistryUtil.getItemId(Items.RABBIT_STEW), RegistryUtil.getItemId(Items.COOKED_PORKCHOP), RegistryUtil.getItemId(Items.COOKED_CHICKEN),
            // Fisherman
            RegistryUtil.getItemId(Items.CAMPFIRE),
            // Cartographer
            RegistryUtil.getItemId(Items.CREEPER_BANNER_PATTERN), RegistryUtil.getItemId(Items.FLOWER_BANNER_PATTERN), RegistryUtil.getItemId(Items.GLOBE_BANNER_PATTERN), RegistryUtil.getItemId(Items.MOJANG_BANNER_PATTERN), RegistryUtil.getItemId(Items.SKULL_BANNER_PATTERN),
            // Fletcher
            RegistryUtil.getItemId(Items.TIPPED_ARROW), RegistryUtil.getItemId(Items.ARROW)
            // Wandering Trader
    ));
    public static final ItemRestriction INFO_VIEW_VILLAGER_ITEMS_RESTRICTION = new ItemRestriction();

    @Config (type = Config.Type.LIST, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigOptionList INFO_VIEW_VILLAGER_RENDER_STRATEGY = newConfigOptionList("infoViewVillagerRenderStrategy", InfoViewRenderStrategy.ALWAYS);

    @Config (type = Config.Type.LIST, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigOptionList INFO_VIEW_VILLAGER_TARGET_STRATEGY = newConfigOptionList("infoViewVillagerTargetStrategy", InfoViewTargetStrategy.DEFAULT);

    @Config (type = Config.Type.GENERIC, category = Config.Category.FEATURES)
    public static final TweakerMoreConfigDouble INFO_VIEW_ENTITY_TARGET_DISTANCE = newConfigDouble("infoViewEntityTargetDistance", 16, 4, 48);
    ...
    static void onConfigLoaded () {
        ...
        TweakerMoreConfigs.AUTO_FILL_CONTAINER_RESTRICTION.setListType((UsageRestriction.ListType) TweakerMoreConfigs.AUTO_FILL_CONTAINER_LIST_TYPE.getOptionListValue());
        TweakerMoreConfigs.AUTO_FILL_CONTAINER_RESTRICTION.setListContents(TweakerMoreConfigs.AUTO_FILL_CONTAINER_BLACKLIST.getStrings(), TweakerMoreConfigs.AUTO_FILL_CONTAINER_WHITELIST.getStrings());

        TweakerMoreConfigs.INFO_VIEW_VILLAGER_ENCHANTED_ITEMS_RESTRICTION.setListType(UsageRestriction.ListType.WHITELIST);
        TweakerMoreConfigs.INFO_VIEW_VILLAGER_ENCHANTED_ITEMS_RESTRICTION.setListContents(new ArrayList<>(),TweakerMoreConfigs.INFO_VIEW_VILLAGER_ENCHANTED_ITEMS_LIST.getStrings());
        TweakerMoreConfigs.INFO_VIEW_VILLAGER_ITEMS_RESTRICTION.setListType(UsageRestriction.ListType.WHITELIST);
        TweakerMoreConfigs.INFO_VIEW_VILLAGER_ITEMS_RESTRICTION.setListContents(new ArrayList<>(),TweakerMoreConfigs.INFO_VIEW_VILLAGER_ITEMS_LIST.getStrings());
    }
